...
public class Management {
    ...
    void hireTest3() {
        ...
        Contract p1 = new PermanentContract(2, true, 6000, 200, 17);
        Contract p2 = new PermanentContract(3, false, 5000, 150, 19);
        Contract t1 = new TemporaryContract(60, 30);
        Contract t2 = new TemporaryContract(50, 60);
        Contract p3 = new PermanentContract(1, true, 4000, 100, 20);
        Contract p4 = new PermanentContract(4, true, 4500, 100, 19);
        ...
        Contract p5 = new PermanentContract(1, true, 5000, 200, 30);
